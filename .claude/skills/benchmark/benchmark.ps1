...
# of the fourteen scenes at random per launch and two of them bring a dome of their own.
param(
    [string[]]$Scenes  = @('city', 'sea', 'savanna', 'desert', 'mountain', 'meadow', 'neon', 'forest', 'space', 'dream', 'cavern', 'moon', 'outback', 'tropical'),
    [int[]]$Ssaa       = @(1, 2),

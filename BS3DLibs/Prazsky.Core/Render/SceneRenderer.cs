...
namespace Prazsky.Core.Render
{
    ...
    public sealed class SceneRenderer : IDisposable
    {
        ...
        //The device, the full-screen quad, the supersampling factor, the seed offset and the billboard index
        //builder, handed to every backdrop.
        ...
        public SceneRenderer(GraphicsDevice graphicsDevice, ContentManager content, int seedOffset = 0)
        {
            ...
            _services = new BackdropServices(graphicsDevice, _fullScreenQuad, seedOffset);

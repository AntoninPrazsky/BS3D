...
namespace Prazsky.Core.Render
{
    ...
    public sealed class SkyLightRig
    {
        ...
        /// trophy cup (#232's second half). <see cref="ApplyTo(InstancedModelRenderer)"/>'s ordinary push is exactly right for most of
        /// every scene: the cup reflects the level's own dome, which is the whole point of enrolling

...
namespace BS3D.Effects
{
    ...
    /// the front end's wordmark, which stands over whichever scene happens to be rolling.
    /// <para>
...
/// </para>
    ...
    public sealed class TrophyPodium : IDisposable
    {
        ...
        public TrophyPodium(GraphicsDevice device, Effect instancingEffect, float ambientIntensity)
        {
            ...
            //by whichever scene the result page actually stands over, refreshed on every

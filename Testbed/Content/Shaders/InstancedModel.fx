...
//A cheap 1D hash for the per-lane variation. Its own rather than the Hash21 further down this file, which is
//declared after this technique and so is not in scope here.

...
//Tento projekt sloužil jako playground pro testování kódu, dál už nebude potřeba (30. 12. 2019)
...
namespace Testbed
{
	public class Testbed : Game
	{
		...
		private void BallsConstraintsBuilderTest()
		{
			...
			//map.PutBallAt(4, 4, 9, eBallType.Type1);
			map.PutBallAt(4, 5, 9, eBallType.Type2);
			map.PutBallAt(4, 6, 9, eBallType.Type3);
			//map.PutBallAt(4, 7, 9, eBallType.Type1);

			map.PutBallAt(5, 4, 9, eBallType.Type2);
			//map.PutBallAt(5, 5, 9, eBallType.Type3);
			...
			//map.PutBallAt(6, 6, 9, eBallType.Type1);
			map.PutBallAt(6, 7, 9, eBallType.Type1);

			//map.PutBallAt(7, 4, 9, eBallType.Type2);
			map.PutBallAt(7, 5, 9, eBallType.Type3);
			map.PutBallAt(7, 6, 9, eBallType.Type1);
			//map.PutBallAt(7, 7, 9, eBallType.Type1);
			...
			map.PutBallAt(7, 4, 5, eBallType.Type2);
			map.PutBallAt(7, 5, 5, eBallType.Type3);
			map.PutBallAt(7, 6, 5, eBallType.Type1);
			map.PutBallAt(7, 7, 5, eBallType.Type3);
